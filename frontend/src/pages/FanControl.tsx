  ...
  return (
    <div>
      ...
      <div className="grid grid-4" style={{ marginBottom: 18 }}>
        ...
        <div className="card metric-card"><div className="card-title">Manual target</div><div className="card-value">{config?.manual_speed ?? manualSpeed}%</div><div className="card-subtitle">Requested duty; RACADM fallback is a minimum floor</div></div>
